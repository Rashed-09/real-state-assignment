      ...
      <div className="shadow-inner border m-2 rounded-none">
        <div className="card-body">
          <div className="relative">
            ...
            <p className="absolute top-12 bg-green-600 text-white font-medium rounded-r-3xl pr-3 text-xs py-1">
              Call For Price
            </p>
          </div>
...
export default ForSellDetails;
ForSellDetails.propTypes = {
